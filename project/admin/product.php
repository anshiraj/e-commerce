...
<div class="table-responsive">
  ...
  <?php 
    ...
    <tr>
      ...
      <td><img src="../image/<?php echo $data['product_image']; ?>" width="100px"></td>
      <td><?php echo $data['product_name']; ?></td>
      <td><?php echo $data['price']; ?></td>
      <td><a href="delete_p.php?id=<?php echo $data['id']?>" class="btn btn-danger"><span class="glyphicon glyphicon-remove"></span></a></td>
    </tr>
                           <?php } ?>
     </tbody>
